    ...
    "
          ...
          <label className="relative w-full my-3">
            <textarea
              type="text"
              id="description"
              className="block py-3 text-white w-full text-sm rounded-lg bg-transparent border-2 border-yellow-500 appearance-none focus:outline-none focus:border-2 focus:border-yellow-500 peer"
            ...
            <div className="flex items-center gap-2">
              <label className="relative w-full my-3">
                <input
                  ...
                  min="0"
                  max="10000"
                  className="block py-3 text-white w-full text-sm rounded-lg bg-transparent border-b-2 border-yellow-500 appearance-none focus:outline-none"
        ...
        <div className="flex flex-col flex-1 gap-4  text-white">
          ...
          <div className="flex gap-4">
            ...
            <button
              type="button"
              disabled={uploading}
              className="p-3 text-green-700 border border-yellow-500 rounded uppercase hover:shadow-lg disabled:opacity-[80%]"
          ...
          <button
            ...
            className="p-3 bg-custom-blue text-green-700 border border-yellow-500 rounded-lg uppercase hover:opacity-[95%] disabled:opacity-[80%]"
          >
